...
public class Zad06_WorldSwimmingRecord {
    public static void main(String[] args) {
     ...
     резултатът трябва да се закръгли надолу до най-близкото цяло число.
        ...
        */
        ...
        //Пресмятаме колко ще се забави на всеки 15 сек.
        //Пресмятаме общия резултат в секунди.
        //Проверяваме дали времето е достатъчно, за да подобри рекорда.

        double delay = (Math.floor(distance / 15)) * 12.5; //забавянето
        double result = (distance * timeSeconds) + delay;
